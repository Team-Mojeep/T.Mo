...
function Main(): JSX.Element {
  ...
  return (
    <S.Wrapper>
      <S.MainTitle>프로젝트</S.MainTitle>
      <S.Nav>
        <S.NavRightWrapper>
          <S.NavTitle>ALL</S.NavTitle>
          <S.NavTitle>Web</S.NavTitle>
          <S.NavTitle>App</S.NavTitle>
          <S.NavTitle>Ect</S.NavTitle>
        </S.NavRightWrapper>

        <S.NavleftWrapper>
          <S.NavSearchWrapper>
            <S.NavSearchIcon src={Search} />
            <S.NaveSearchInput placeholder="검색" />
          </S.NavSearchWrapper>
          <S.NavAddButton>+</S.NavAddButton>
        </S.NavleftWrapper>
      </S.Nav>
